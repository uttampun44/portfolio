...
const Icons = {
    ...
    logout: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_1_343)">
            <path d="M7.33333 19.25H3.12492C3.02556 19.2498 2.93034 19.2102 2.86008 19.1399C2.78982 19.0697 2.75024 18.9744 2.75 18.8751V3.12492C2.75024 3.02556 2.78982 2.93034 2.86008 2.86008C2.93034 2.78982 3.02556 2.75024 3.12492 2.75H7.33333C7.69801 2.75 8.04774 2.60513 8.3056 2.34727C8.56347 2.08941 8.70833 1.73967 8.70833 1.375C8.70833 1.01033 8.56347 0.660591 8.3056 0.402728C8.04774 0.144866 7.69801 0 7.33333 0L3.12492 0C2.29643 0.000970404 1.50216 0.330513 0.916339 0.916339C0.330513 1.50216 0.000970404 2.29644 0 3.12492L0 18.8751C0.000970404 19.7036 0.330513 20.4978 0.916339 21.0837C1.50216 21.6695 2.29643 21.999 3.12492 22H7.33333C7.69801 22 8.04774 21.8551 8.3056 21.5973C8.56347 21.3394 8.70833 20.9897 8.70833 20.625C8.70833 20.2603 8.56347 19.9106 8.3056 19.6527C8.04774 19.3949 7.69801 19.25 7.33333 19.25Z" fill="#7F8F98" />
            <path d="M20.792 8.08252L17.2335 4.52677C17.1058 4.39911 16.9542 4.29785 16.7873 4.22879C16.6205 4.15972 16.4416 4.12419 16.261 4.12424C16.0805 4.12428 15.9017 4.15989 15.7348 4.22904C15.568 4.29818 15.4164 4.39951 15.2888 4.52723C15.1611 4.65495 15.0599 4.80657 14.9908 4.97342C14.9217 5.14027 14.8862 5.31909 14.8863 5.49968C14.8863 5.86438 15.0313 6.21411 15.2892 6.47194L18.4169 9.59869L5.9585 9.62435C5.59382 9.62435 5.24409 9.76922 4.98622 10.0271C4.72836 10.2849 4.5835 10.6347 4.5835 10.9994C4.5835 11.364 4.72836 11.7138 4.98622 11.9716C5.24409 12.2295 5.59382 12.3744 5.9585 12.3744L18.4673 12.3514L15.2892 15.5295C15.0465 15.7903 14.9144 16.1351 14.9209 16.4913C14.9273 16.8475 15.0718 17.1873 15.3238 17.4391C15.5759 17.691 15.9158 17.8351 16.272 17.8412C16.6283 17.8473 16.973 17.7149 17.2335 17.4719L20.7892 13.9162C21.1723 13.5331 21.4761 13.0784 21.6834 12.5779C21.8908 12.0775 21.9974 11.5411 21.9974 10.9994C21.9974 10.4576 21.8908 9.92124 21.6834 9.42077C21.4761 8.9203 21.1723 8.46556 20.7892 8.08252H20.792Z" fill="#7F8F98" />
        </g>
        <defs>
    ...
    blog: <svg width="60" height="60" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="42" cy="42" r="42" fill="url(#paint0_linear_501_236)"/>
    <path d="M32.27 24.5H51.7125C57.9425 24.5 59.5 26.0575 59.5 32.27V43.3475C59.5 49.5775 57.9425 51.1175 51.73 51.1175H32.27C26.0575 51.135 24.5 49.5775 24.5 43.365V32.27C24.5 26.0575 26.0575 24.5 32.27 24.5Z" stroke="#00AC4F" strokeWidth="2.625" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M42 51.1345V59.4995" stroke="#00AC4F" strokeWidth="2.625" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M24.5 43.75H59.5" stroke="#00AC4F" strokeWidth="2.625" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M34.125 59.5H49.875" stroke="#00AC4F" strokeWidth="2.625" strokeLinecap="round" strokeLinejoin="round"/>
    <defs>
    ...
    star: <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    <circle cx="12" cy="12" r="4"></circle>
    <path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7"></path>
   </svg>,
    
    darkStar:<svg  viewBox="0 0 24 24">
